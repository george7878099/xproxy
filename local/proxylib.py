...
class DirectFetchPlugin(BaseFetchPlugin):
    ...
    def handle_method(self, handler, kwargs):
        ...
        try:
            ...
            response = handler.net2.create_http_request(method, url, headers, body, timeout=handler.net2.timeout, read_timeout=self.read_timeout, validate=True, handler=handler, **kwargs)
